...
//----------------------------------------
credits_02:
	db $22,$47,$12	// PPU transfer to $224C
	db "     PRODUCER     ",{end}
credits_03:
	db $22,$88,$10	// PPU transfer to $2288
...
credits_10:	// Repoint 1, 0xEFE6
	...
	db "  PROGRAMMER  ",	{end}
credits_11:
	db $22,$88,$10	// PPU transfer to $2289
	db " KAZUAKI MORITA "
...
credits_13:
	db $22,$87,$13	// PPU transfer to $2286
	db " TOSHIHIKO NAKAGO  "
	db $22,$C8,$10	// PPU transfer to $22C8
	db "                ",	{end}
//----------------------------------------
...
//----------------------------------------
credits_15:
	db $22,$87,$11	// PPU transfer to $2287
	db "    PRESS START  "
	db $22,$CC,$09	// PPU transfer to $22cB
	db "TO REPLAY",	{end}
//----------------------------------------
// Fill to 0x15410 with $FF
	fillto $16600,$FF
